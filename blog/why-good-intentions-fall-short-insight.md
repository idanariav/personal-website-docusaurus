---
UUID: 20230908161307
Created: '2023-09-08 16:13'
Modified: '2025-12-08 21:22'
tags:
  - habits
  - change
  - control
Platform:
  - Obsidian
URL:
  - 'https://philosophers-code.kit.com/posts/habits-vs-defaults'
  - 'https://idanariav.com/blog/habits-vs-defaults'
Description: 'We need to work smarter, not harder to get better results'
...
IssueNum: 30
aliases: []
vc-id: Content_Insights_Why Good Intentions Fall Short (insight)_md
draft: false
slug: habits-vs-defaults
...
Much of our daily choices aren't choices at all. We live on auto-pilot mode of the time,
which often leads to regretful behavior. How can we bridge the gap between our good intentions and our actual actions? The answer lies in harnessing how our lazy brain works.
...
If you've read "Atomic Habits", the next part will sound familiar. If you haven't, I highly recommend it, but here is the short version.
To build a habit, make it obvious, attractive, easy, and satisfying. To break a bad one, do the opposite: make it invisible, unattractive, difficult, and unsatisfying.
