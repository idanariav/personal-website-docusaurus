...
URL:
  - 'https://philosophers-code.kit.com/posts/knowing-and-experiencing'
  - 'https://idanariav.com/blog/knowing-and-experiencing'
Description: >-
  Decisions in life are a type of experience knowledge. We can't logically
  calculate the right one. When faced with a tough choice, our choice is
  influenced mostly by our virtues, which we should cultivate
...
Version: 1
IssueNum: '35'
Image: '[[The difference between knowing and experiencing (insight).png]]'
aliases: []
draft: false
slug: knowing-and-experiencing
