...
Description: >-
  It argues that perfectionism hinders progress, suggesting to set achievable
  goals and focus on what truly matters. Emphasizing the importance of enjoyment
  in tasks, it encourages cutting distractions and redefining success to foster
  motivation and completion.
FullTitle: Finish - Give Yourself the Gift of Done
StartDate: 2025-08-01T00:00:00.000Z
ASIN: B01N4VVT1Z
Reread: 0
Topic:
  - '[[Clear direction matters more than speed of progress|Goal Setting]]'
Origin: null
draft: false
SiteProcssed: true
---
...
1. **Allow Imperfection** - lower your standards and deliberately accept imperfect work so you can keep moving forward rather than stopping for perfect results.
2. **Cut Your Goal in Half** - reduce the scope of a goal by 50% (or double the timeline) and commit to that smaller target to build momentum.
3. **Choose What to Bomb** - list tasks you will stop doing and say “no” to lower-priority obligations so you can reallocate time to the new goal.
4. **Make the Work Fun** - add enjoyment or gamification to the process (temptation bundling or reward mechanisms) to increase motivation and consistency.
5. **Eliminate Hiding Places** - identify your distractions and pseudo‑productive activities (e.g., Netflix, endless email) and remove or block them before starting work.
6. **Simplify the Problem** - replace overly ambitious approaches with easier versions (solve the easier problem or relax requirements) to ensure progress.
7. **Expose and Rewrite Secret Rules** - identify personal “must” rules (e.g., “easy is cheating”) and write new, practical rules or affirmations to replace them.
8. **Track Relevant Data** - record inputs and outputs regularly to get objective feedback on progress (measure what you do, not just outcomes).
9. **Review and Adjust Based on Data** - schedule reviews of your data and change either the goal, the deadline, or your actions when progress is insufficient.
10. **Ask for Peer Support Near Completion** - when fear of finishing or negative feedback stalls you, reach out to a friend or peer for perspective and encouragement.
...
![Finish (book)](/books/finish-book.webp)
## Notes
...
The main obstacle to finishing is [Perfectionism paralyzes action through unattainable standards](/notes/perfectionism-paralyzes-action-through-unattainable-standards.md). We must do whatever it takes to keep moving forward, which means lowering our standards, making the process enjoyable, using shortcuts, and taking small steps. [Perfect is the enemy of good](/notes/perfect-is-the-enemy-of-good.md)
...
Perfectionism leads to [Binary thinking reduces complexity to false dichotomies](/notes/binary-thinking-reduces-complexity-to-false-dichotomies.md), where we think, "It's either perfect and worth doing" or "not at all." We may skip our goals due to mistakes, circumstances, or choices, breaking our momentum and losing motivation to get back on track [Absolute rules trade flexibility for willpower savings](/notes/absolute-rules-trade-flexibility-for-willpower-savings.md).
...
We are often foolishly and naively optimistic when setting our goals, falling victim to [We underestimate task duration through overconfident predictions](/notes/we-underestimate-task-duration-through-overconfident-predictions.md). That's why you need to **cut your goal in half**.

It's all about adjusting our [Expectations shape wellbeing through the gap between desires and reality](/notes/expectations-shape-wellbeing-through-the-gap-between-desires-and-reality.md). When a goal is too big, we either fail to finish on time and become discouraged or complete it without any energy left. Goals are a marathon, not a sprint. By halving our goals, we increase our chances of success, creating [Momentum is movement that builds self-reinforcing forward action](/notes/momentum-is-movement-that-builds-self-reinforcing-forward-action.md) to continue beyond the small goal and often past the original goal.
...
When perfectionism can't stop you, it [Distracts](/notes/distractions-pull-us-towards-them-as-a-temptation.md) you. Since you "know" you can't do it perfectly, you distract yourself with other activities. The first type is *hiding places*, where you know you can't mess up.
...
If you have to make creative [excuses](/notes/we-justify-our-conclusions-after-acting-not-before.md) for why what you're doing is valuable, it probably isn't.
...
While perfectionism pushes us to do above and beyond, we should strive to simplify. Consider how you can [relax](/notes/simplify-the-problem-before-trying-to-solve-it.md) the problem.
...
The problem with these rules is that they remain secret. It takes deep [Introspection develops self-knowledge through internal examination](/notes/introspection-develops-self-knowledge-through-internal-examination.md) to uncover them.

Once you've realized what holds you back, look around and [copy](/notes/imitation-internalizes-others-behaviors-and-mental-models-at-varying-depths.md) what others are doing; learn from their experiences and wisdom.
...
:::note[Get Rid of Your Secret Rules]
