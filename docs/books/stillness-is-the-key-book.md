...
Description: >-
  It argues that true freedom comes from stillness amidst chaos, requiring a
  clear mind to translate wishes into actions. By purifying the soul and
  conserving energy, one can cultivate purpose, maintain virtues, and embrace
  life with minimal distractions and commitments for a more fulfilling
  existence.
Author:
  - '[[Ryan Holiday]]'
...
1. **Slow down and think deeply** - pause before acting and analyze situations carefully to find hidden components and avoid quick, shallow conclusions.
2. **Limit your inputs** - reduce the flow of information, set filters, and prioritize using methods like the Eisenhower matrix to separate important from urgent.
3. **Empty your mind regularly** - create deliberate moments to clear intrusive thoughts so you don’t overthink or second-guess during tasks.
4. **Become present** - practice focusing on the current moment to reduce regret and worry and to use energy on what’s directly in front of you.
5. **Start journaling** - write regularly to ask yourself tough questions, reflect on obstacles, track gratitude, and plan small steps toward big goals.
6. **Cultivate silence and seek solitude** - schedule quiet time away from noise to refocus, restore creativity, and think without distraction.
7. **Say no more often** - refuse commitments that dilute attention so you can protect time and energy for what truly matters.
8. **Build and follow a routine** - establish rituals that bring bodily order and conserve mental energy for meaningful work.
9. **Go to sleep and prioritize rest** - protect sufficient sleep and leisure to maintain health, productivity, and long-term wellbeing.
10. **Choose virtue and act bravely** - practice kindness, humility, honesty, and courage; replace anger with gratitude and align actions with your values.
...
![Stillness Is Key (book)](/books/stillness-is-key-book.webp)
...
Stillness is not only a way to quiet the mind, but also to slow down time [Slowing down prioritizes quality over speed and enables reflection](/notes/slowing-down-prioritizes-quality-over-speed-and-enables-reflection.md). To think before acting, which is even harder in modern time when we are overstimulated [Our attention is the product that media companies sell](/notes/our-attention-is-the-product-that-media-companies-sell.md), [stressed](/notes/stress-can-be-adaptive-or-harmful-depending-on-perception-and-context.md) and expected to act fast otherwise we will miss out life [Fear of missing out fuels anxiety about opportunities we cannot take](/notes/fear-of-missing-out-fuels-anxiety-about-opportunities-we-cannot-take.md) [Hustle culture equates busyness with progress and causes burnout](/notes/hustle-culture-equates-busyness-with-progress-and-causes-burnout.md). **Stillness is not a "nice to have", it's key to any success and wellbeing in life that we want to have**. Only by seeing things clearly, we can act with effectiveness towards the right things [Seeing reality without subjective bias reduces distortion](/notes/seeing-reality-without-subjective-bias-reduces-distortion.md) [mindfulness](/notes/intentionality-is-conscious-presence-that-replaces-automatic-default-behavior.md).
...
We can't allow ourselves to stick with our [Gut Feeling](/notes/heuristics-are-mental-shortcuts-enabling-fast-automatic-decisions.md), most of the time our initial impulse is mistaken [First attempts are inherently lower quality than iterations](/notes/first-attempts-are-inherently-lower-quality-than-iterations.md).

We first have to stop, try to understand the other side [Listening well requires active effort to understand](/notes/listening-well-requires-active-effort-to-understand.md), the situation in a clear way before we jump to conclusions. We have to [rethink](/notes/rethinking-means-updating-beliefs-by-reconsidering-what-you-thought-you-knew.md), and don't give in to our emotions.

:::note[THE DOMAIN OF THE MIND]
...
We are surrounded by [Noise obscures truth with external interference and confusion](/notes/noise-obscures-truth-with-external-interference-and-confusion.md), which makes it harder to implement [Prioritization](/notes/triage-prioritizes-limited-resources-by-allocating-attention-wisely.md), i.e to [separate](/notes/filtering-is-choosing-what-to-consume-before-distilling-it.md) the important from the unimportant, because we are too focused on the false sense of urgency this constant stream of information is causing us. If we have no filters on the amount and quality of information going in, don't be surprised if you make bad decision [GIGO](/notes/output-quality-depends-on-input-quality.md)

We should be better at [distilling](/notes/distilling-separates-essence-from-noise-to-simplify-understanding.md) information, and the easiest way is to limit our inputs, to consume less information, to be harder to reach, and wee which information prevails, this is usually the important one. Use tools such as the [Eisenhower matrix](/notes/eisenhower-matrix.md) to separate the important from the urgent.

#### Empty Your Mind

When our brain is overwhelmed with thoughts, there are no resources left for it to function, it focuses on the thoughts rather than the action. By clearing our minds [Every system needs empty space to function](/notes/every-system-needs-empty-space-to-function.md) we free ourselves to be the best we can be.
...
[Journaling enables reflection and self-understanding through written documentation](/notes/journaling-enables-reflection-and-self-understanding-through-written-documentation.md) is a good method for [Introspection develops self-knowledge through internal examination](/notes/introspection-develops-self-knowledge-through-internal-examination.md), to explore the depths within you, to ask and answer the tough questions like what bothers me, how can I become a better person, which hard choices I'm avoiding, what am I grateful for. It doesn't matter how you journal, as long as you do it regularly.
...
Silence is underrated, since we are so surrounded by noise, we often forget to appreciate the benefits of silence, to be alone with our thoughts [Solitude enables introspection and deep cognitive work](/notes/solitude-enables-introspection-and-deep-cognitive-work.md)

#### Seek Wisdom

To seek wisdom is to avoid [Conformation bias makes us accept confirming evidence without scrutiny](/notes/conformation-bias-makes-us-accept-confirming-evidence-without-scrutiny.md), to seek knowledge and have [Humility is acknowledging limits of knowledge and fallibility](/notes/humility-is-acknowledging-limits-of-knowledge-and-fallibility.md) while doing it. Never let go of doubt, remember that you might be wrong, yet try to gain as much knowledge and experience as possible to overcome it.
...
Avoid [Overestimating abilities blinds us to genuine risks](/notes/overestimating-abilities-blinds-us-to-genuine-risks.md) at all costs, but don't fall into [Imposter syndrome is feeling undeserving despite actual competence](/notes/imposter-syndrome-is-feeling-undeserving-despite-actual-competence.md) either. Have [Self-worth is accurate assessment of your capabilities](/notes/self-worth-is-accurate-assessment-of-your-capabilities.md) to trust your knowledge and skills, to decide who and what to listen to, while not trying to prove yourself to anyone.
...
If we focus too much on our goals, we will fail [Excessive striving produces the opposite of intended outcomes](/notes/excessive-striving-produces-the-opposite-of-intended-outcomes.md), we have to [Focusing on process and consistency yields better results than obsessing over outcomes](/notes/focusing-on-process-and-consistency-yields-better-results-than-obsessing-over-outcomes.md) and remained focus on our performance rather than what we are trying to achieve.

### Spirit

#### The Domain of the Spirit

We can't accept others if we don't accept ourselves, we can't live in harmony with the world if we are at war with ourselves [Achieving internal harmony requires integrating all parts of yourself](/notes/achieving-internal-harmony-requires-integrating-all-parts-of-yourself.md). To live well requires a good soul. One that steer clear of negative emotions, that has a strong moral compass, that accept that life is not an endless pursuit after more and more, but rather accepting what we have, and find happiness in it, that cultivate kindness to itself and others.
...
[Desire perpetuates endless wanting over satisfaction](/notes/desire-perpetuates-endless-wanting-over-satisfaction.md) Can lead us astray, as with any feeling it can be fleeting and doesn't have to have control over us, and surely not define us. By taking a pause to notice the feeling when it happens we can see it for what it really is, much smaller than the power we once gave it
...
We are not meant to be alone [Human is a social being](/notes/human-is-a-social-being.md), for our happiness, our success, our sanity, we need [Deep relationships require trust, listening, and empathy](/notes/deep-relationships-require-trust-listening-and-empathy.md) in our lives. To keep us honest, on the right track, and share our feelings with [Happiness is shared](/notes/happiness-is-shared.md).
...
[Anger is information that something should be different](/notes/anger-is-information-that-something-should-be-different.md) is a problematic emotion. It has a tendency of hurting us more than others, of self sabotage and many moments of [We regret inaction more than action taken](/notes/we-regret-inaction-more-than-action-taken.md). The only advantage of anger is that it works as a fuel, but we can find a different source of energy. By replacing anger with love, gratitude, kindness, we maintain high levels of energy while keeping ourselves calm and collected [Turn negative emotions into fuel for growth and action](/notes/turn-negative-emotions-into-fuel-for-growth-and-action.md) *for some reason I thought of cold fusion instead of nuclear fusion in this case*
...
We are not thoughts floating through the air, we are psychical beings, and this means that we are bound by it's limit. To have a body means that everything is about energy management. If we push ourselves too hard, if we neglect our body, all of our efforts will be blocked or useless [Burnout is chronic exhaustion from overwhelming demands](/notes/burnout-is-chronic-exhaustion-from-overwhelming-demands.md). We should be mindful of our limited energy, notice how can we preserve and generate more, and which activities are worth the investments [Scarcity forces prioritization when resources are limited](/notes/scarcity-forces-prioritization-when-resources-are-limited.md)
...
[Nature restores mental health and renews focus through immersive presence](/notes/nature-restores-mental-health-and-renews-focus-through-immersive-presence.md) is good for mindfulness and creativity
...
To have a routine is a way to quiet the body, to instill order around you to match the order in your mind, to help mitigate the bad feeling when [Luck is external randomness affecting outcomes beyond control](/notes/luck-is-external-randomness-affecting-outcomes-beyond-control.md) is not on your side. [Rituals bypass overthinking by replacing decisions with steps](/notes/rituals-bypass-overthinking-by-replacing-decisions-with-steps.md).

#### Get Rid of Your Stuff

We have to be sure our stuff don't own us instead. The more we accumulate, the more are we bound by it. More stuff demands a bigger house, more upkeep, and the more our happiness becomes dependent on those things, which makes it even more crushing when we lose them [Attachment distorts how we see the things we cling to](/notes/attachment-distorts-how-we-see-the-things-we-cling-to.md). The key for independence is [Minimalism](/notes/improvement-often-comes-from-removing-rather-than-adding.md), to be free is to need fewer things.
...
If we try to have it all, in the best case scenario we will experience burnout. In the worst case, we will kill ourselves from stress and exhaustion. We need [Moderation](/notes/optimal-outcomes-emerge-from-balance-between-extremes-not-absolutes.md) in our lives, to pace our work while we also take care of ourselves

#### Go to Sleep

[Sleep is essential for cognitive function and peak performance](/notes/sleep-is-essential-for-cognitive-function-and-peak-performance.md) is one of the most important things we can do to maintain our health and our productivity, it's far from a luxury.
...
Not only that we can't outrun despair, just the attempt is counterproductive. [Escapism is withdrawing from difficulty through distraction and avoidance](/notes/escapism-is-withdrawing-from-difficulty-through-distraction-and-avoidance.md) quickly becomes [Addiction is escapism that destroys self-control](/notes/addiction-is-escapism-that-destroys-self-control.md) that only makes the problem worse. We can't escape our life, we can only solve it by making better decisions, by understanding ourselves, by building a life we won't want to escape from.
