...
Image: >-
  ...
  motivation.png]]
ImageText: A yawning face with closed eyes
Description: >-
...
1. Boring tasks - sometimes we just have to do things that are boring, like washing dishes or filling forms. We can't avoid those, so perhaps adding a layer of [Gamification increases motivation by making activities enjoyable](/notes/gamification-increases-motivation-by-making-activities-enjoyable.md) or [Bundling undesired tasks with enjoyable activities increases motivation](/notes/bundling-undesired-tasks-with-enjoyable-activities-increases-motivation.md) can make the experience more enjoyable
2. changing course - if what bores us is our job, and not just small parts of it that are a natural part of every job, but rather the role as a whole, perhaps it's a sign we should [quit](/notes/knowing-when-to-stop-prevents-wasted-persistence-on-misaligned-goals.md)
