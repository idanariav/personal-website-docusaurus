...
Rationalization is when we first come to a conclusion, and only after the fact do we find justifications to our actions [Confusing current reality with how things should be blocks change](/notes/confusing-current-reality-with-how-things-should-be-blocks-change.md), we use the situation as a justification, rather than first finding justifications which leads to actions.
...
However there are also potential advantages. This is perhaps the reason that [Being emerges from action not belief](/notes/being-emerges-from-action-not-belief.md) works because if we act like the person we want to be, we rationalize it that we are truly becoming that person. [change starts from the inside out](/notes/change-starts-from-the-inside-out.md).
