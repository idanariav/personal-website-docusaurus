...
Version: 1
Image: '[[Fake it till you make it.png]]'
...
We tend to believe that [change starts from the inside out](/notes/change-starts-from-the-inside-out.md), that we first have to decide who we are, and only then we can implement it. First, we must achieve [Mastery](/notes/mastery.md) through rigorous studies, and then we can truly claim the title. With this much pressure, when development is only one-sided and happens [once](/notes/binary-thinking.md), from being to doing, then it is no wonder we often feel like [Imposter Syndrome](/notes/imposter-syndrome.md)
...
![Fake it till you make it](/notes/fake-it-till-you-make-it.webp)

## Overview
🔼Topic:: [behavioral psychology (Map)](/notes/behavioral-psychology-map.md)
Origin::
🔗Link::
