...
Modified: '2026-08-03 07:52'
tags: []
Version: 4
Description: >-
  A concept suggesting that while societies share common moral values, the
...
new_schema: true
Drawings:
  - '[[Morality is a shared palette mixed in different proportions (sketch)]]'
draft: false
SiteProcssed: true
---
...
1. **Care vs Harm** - originated from our need to care for the next generation. [Morality must account for relationships and context](/notes/morality-must-account-for-relationships-and-context.md)
...
However, I believe that there are 8 moral taste buds, which are:
...
I believe that the way he presents it is problematic. Each scale is made of one end which is obviously superior (who wants betrayal or harm?) and it misses the nuances of the other side. Also, I think that there are some points there are missing.

### Open Questions

## Visual

![Morality is a shared palette mixed in different proportions (sketch)](/sketches/morality-is-a-shared-palette-mixed-in-different-proportions-sketch.webp)
