...
Happiness is not a destination, it's a journey. If our happiness depends on "when I'll have x I'll be happy", we will never be happy because we either won't achieve it, or by the time we'll do we will have a different goal [Deferring happiness to future goals creates present suffering](/notes/deferring-happiness-to-future-goals-creates-present-suffering.md).
...
Happiness will be easier to achieve when we would use things less for their [Instrumental value treats things as means rather than ends](/notes/instrumental-value-treats-things-as-means-rather-than-ends.md) value, and focus more on their [Some things matter for what they are not what they do](/notes/some-things-matter-for-what-they-are-not-what-they-do.md) value.
...
It is to live in [Moderation](/notes/optimal-outcomes-emerge-from-balance-between-extremes-not-absolutes.md) and [Minimalism](/notes/improvement-often-comes-from-removing-rather-than-adding.md), to see that the less we need, the happier we can be.
