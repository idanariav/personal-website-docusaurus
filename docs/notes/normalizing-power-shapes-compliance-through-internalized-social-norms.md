...
For example, an influencer that uses the word "slay" a lot in an attractive way can turn this word from a negative context to a positive ones, suddenly we can hear people say things like "this outfit is slay" which is meant as a compliment.
