...
For example, we don't control (to an extent) whether we are hurt in an accident, get cancer, or lose a family member. Yet, to become a [victim](/notes/helplessness-is-perceiving-no-control-over-circumstances-and-outcomes.md), to dwell in that pain for years, letting it take over our lives, is our choice.
