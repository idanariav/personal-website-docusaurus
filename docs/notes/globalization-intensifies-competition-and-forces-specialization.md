...
Automation and [Delegating production trades control for efficiency](/notes/delegating-production-trades-control-for-efficiency.md) is a similar threat, where jobs that we tended to feel secure in are now replaced by others, whether machines or humans.
