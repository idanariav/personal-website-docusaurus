...
Simplicity is the idea that [less is more](/notes/improvement-often-comes-from-removing-rather-than-adding.md). That by [trimming](/notes/distilling-separates-essence-from-noise-to-simplify-understanding.md) something down to the core we can get a much more refined, [understandable](/notes/clarity-is-achieved-through-definition-and-presentation.md) and implementable idea [Content is independent from the medium that transmits it](/notes/content-is-independent-from-the-medium-that-transmits-it.md).
...
Simple is elegant, is beautiful, but most of all it is [Flexible](/notes/our-beliefs-must-adapt-as-context-and-goals-change.md). The easier something is, the more it's robust to changes, and can be used in various situations.
