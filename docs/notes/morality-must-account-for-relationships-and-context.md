...
Ethics of care is a moral view that takes into consideration relationships and social obligations and connection between humans and the environment we live.

### Explanation

Originated from the difference in moral reasoning between men and women. Men tended to stick to logical rational reasoning, either based on rules [Deontology treats morality as duties and rights that transcend consequences](/notes/deontology-treats-morality-as-duties-and-rights-that-transcend-consequences.md) or mathematical calculations [Maximizing pleasure and minimizing suffering defines moral action](/notes/maximizing-pleasure-and-minimizing-suffering-defines-moral-action.md), both trying to derive a one true answer for each moral dilemma.  
...
Kids were tested on a moral dilemma as follows:
