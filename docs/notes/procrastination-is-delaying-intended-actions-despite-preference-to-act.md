...
We distract ourselves because we look for novelty [Distraction by novelty undermines commitment and depth](/notes/distraction-by-novelty-undermines-commitment-and-depth.md), which can also be the reason why we are tempted to multitask.
