...
Version: 2
Image: '[[Core Values.png]]'
Description: >-
  Fundamental beliefs that shape identity, behavior, and future goals, providing
  meaning and direction in life, despite potential conflicts or failures to
  adhere to them.
aliases:
  - Core Beliefs
  - Core Principles
