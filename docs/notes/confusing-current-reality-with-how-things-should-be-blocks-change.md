...
Description: >-
  A cognitive bias where the current state of affairs is mistakenly justified as
  desirable, leading to circular reasoning, a blend of facts and values, and
...
3. **Limited view** - when we fall into this bias, we lack the ability to use our [Examining ideas rigorously before accepting them as true](/notes/examining-ideas-rigorously-before-accepting-them-as-true.md) to consider other options as to what can exist otherwise.
4. **Mixing cause and effect** - We treat the current situation as the reason, instead of the outcome, for certain beliefs. Like viewing all poor people as lazy because they don't have a job, so they shouldn't receive any social help, which only makes it harder for them to find a job, which strengthens the view that they are too lazy to find a job. [Self fulfilling prophecy](/notes/being-emerges-from-action-not-belief.md)
