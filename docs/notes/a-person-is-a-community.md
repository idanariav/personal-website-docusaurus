...
The process of unification or rather [Deliberation](/notes/deliberation.md) is not easy, but so is living with conflicts. Neglecting can be harmful to our well-being. It requires [Self-compassion](/notes/self-compassion.md), so that we could [listen](/notes/active-listening.md) and [accept](/notes/validation.md) even the "negative" voices with us, and [Introspection](/notes/introspection.md) in order to realize where are the sources of each of these voices, why do they exist, and what they are trying to accomplish.
