...
It is very hard to improve when you never try to put theory into practice [Active engagement with material accelerates learning](/notes/active-engagement-with-material-accelerates-learning.md). Experimentation is considered the best, if not to only way, to get good [Feedback is information that enables behavioral improvement](/notes/feedback-is-information-that-enables-behavioral-improvement.md) for your skills, your theories and your actions that you couldn't have gotten otherwise.
It is our main source of [Truth](/notes/truth.md), at least in an [empirical](/notes/knowledge-comes-from-empirical-testing-not-innate-reason.md) sense.
